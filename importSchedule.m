...
%   [SHIFTSTART,SHIFTEND] = importSchedule(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [SHIFTSTART,SHIFTEND] = importSchedule(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [shiftStart,shiftEnd] = importSchedule('218.txt',1, 20);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2013/11/11 13:49:20
